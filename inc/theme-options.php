...
function auriel_theme_register_settings(): void {
	...
	add_settings_section(
		...
		__( 'Design Tokens', 'auriel-theme' ),
		static function (): void {
			echo '<p>' . esc_html__( 'Adjust the global colour palette used across the theme. Values are exposed to Tailwind via CSS variables.', 'auriel-theme' ) . '</p>';
		},
		'auriel-theme-settings'
	);

	$fields = array(
		'primary_color'   => __( 'Primary colour', 'auriel-theme' ),
		'secondary_color' => __( 'Secondary colour', 'auriel-theme' ),
		'accent_color'    => __( 'Accent colour', 'auriel-theme' ),
		'surface_color'   => __( 'Surface colour', 'auriel-theme' ),
		'text_color'      => __( 'Text colour', 'auriel-theme' ),
	);
...
function auriel_theme_register_settings_page(): void {
	add_theme_page(
		__( 'Auriel Theme Settings', 'auriel-theme' ),
		__( 'Auriel Theme', 'auriel-theme' ),
		'manage_options',
		'auriel-theme-settings',
...
function auriel_theme_render_settings_page(): void {
	...
	?>
	<div class="wrap">
		<h1><?php esc_html_e( 'Auriel Theme Settings', 'auriel-theme' ); ?></h1>
		<form action="options.php" method="post">
			<?php
			settings_fields( 'auriel_theme_settings' );
			do_settings_sections( 'auriel-theme-settings' );
			submit_button();
			?>
		</form>
	</div>
